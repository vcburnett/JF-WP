		...
		<footer id="colophon" class="site-footer" role="contentinfo">
			<div class="ft-links-section">
				...
				<div class="ft-links">
					<a href="<?php echo get_page_link(10); ?>">About Joe's Fusion</a>
			...
			<div class="ft-metas">
				...
				<p>©2016 Joe’s Fusion. All rights reserved. <a href="<?php echo get_page_link(6); ?>">Terms and Conditions</a> | <a href="<?php echo get_page_link(21); ?>">Privacy Policy</a></p>
		</footer><!-- #colophon -->
...
<script type="text/javascript" src="<?php echo get_template_directory_uri(); ?>/assets/js/instafeed.js"></script>
